...
export function FloatingWhatsApp({ lang }: { lang: Lang }) {
  ...
  return (
    <a
      ...
      rel="noreferrer"
      aria-label={label}
      className="group fixed bottom-5 right-5 z-[60] inline-flex items-center gap-2 rounded-2xl bg-[#1FAF62] p-3.5 text-white shadow-[0_16px_34px_rgba(31,175,98,0.34)] transition duration-200 hover:-translate-y-1 hover:bg-[#168b4c] hover:shadow-[0_20px_40px_rgba(31,175,98,0.38)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1FAF62] focus-visible:ring-offset-2 active:scale-[0.97] sm:bottom-7 sm:right-7"
    >
